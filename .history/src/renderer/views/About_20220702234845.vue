...
export default {
  ...
  mounted() {
    this.timeline = [
      {
        version: '0.4.71',
        detail: ['添加:快捷菜单,日报添加跳转当月功能,page模块头部按钮样式调整;'],
      },
      {
        version: '0.4.71',
        detail: [
          '添加:绘制logo,设置模块,About模块调整,生成初始化文件,月报添加任务数,日报添加重复过滤,日报简称展示调整,项目列表添加表格,项目列表搜索高亮,添加全局分页设置,回收站表格添加分页,项目表文件添加表格,项目表文件搜索高亮,回收站表格添加分页记录,添加全局月报是否显示条数,项目列表添加表格分页和状态记录',
          '修改:系统图标',
        ],
      },
    ]
