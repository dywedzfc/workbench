            ...
            <div class="panel-form" v-for="item in attributesList" :key="item.name">
              ...
              <el-form class="panel-form-wrapper container-form" label-width="60px">
                <el-form-item :label="item.name" v-for="item in item.data" :key="item.name">
                  <el-input class="input-block" v-if="item.inputType == 'input'"></el-input>
                  <el-input class="input-block" v-else-if="item.inputType == 'select'">
                    <el-option v-for="v in item.options" :key="v" :value="v"></el-option>
                  </el-input>
                </el-form-item>
              </el-form>
            </div>
