          ...
          render(h) {
            ...
            el.push(
              h('el-button', {
                ...
                on: {
                  click: () => {
                    const datqa = _this.resetElementData(options.default, obj)
                    _this.$set(_this.result.data, _this.result.data.length, data)
                    _this.result.data.push(..._this.resetElementData(options.default, obj))
                    console.info('data-tt:', _this.result.data)
                  }
                }
              })
            )
