  ...
  methods: {
    ...
    writeEvent(value, key) {
      ...
      return () => {
        ...
        console.info('data-event:', value, data, vdata)
        eval(vdata)
      }
    }
  }
