  ...
  <el-container class="container-wrapper">
    ...
    <el-aside class="container-right" width="300px">
      <div class="panel-header">
        <el-input :value="right.query" readonly @focus="handleQueryPropFocus"></el-input>
      </div>
            ...
            <div class="wrapper">
              <el-button
                :class="[
                  'button-drawer',
                  {
                    query:hasQuery(it,drawer.query)
                      drawer.query && it.title.toLowerCase().includes(drawer.query.toLowerCase())
                  }
                ]"
                size="small"
...
import menuOptions from './json/menu'
...
export default {
  ...
  methods: {
    ...
    handleDrawerButtonClick(item) {
      this.drawer.query = item.title
      this.right.display = false
    },
