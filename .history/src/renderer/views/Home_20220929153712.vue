<template>
  <page title="开心每一天" :back="false">
    ...
    <div class="template-wrapper">
      <logo size="16vw" />
      <search-bar :value="search.query" @query="handleSearchQueryClick" />
      <group-card
  ...
  methods: {
    ...
    handleSearchQueryClick(query) {
      ...
      this.$nextTick(() => {
        ...
        console.info('one:', oneIframe.console)
        ...
        oneIframe.addEventListener('load', () => {
          //   const oneIframe = this.$refs.oneIframe
          //   const iframeDocument = oneIframe.contentDocument
          // setTimeout(() => {
          console.info('data-scss:', oneIframe, iframeDocument, iframeDocument.querySelector('div'))
          // }, 500)
        })
      })
    },
