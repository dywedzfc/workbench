  ...
  <page title="添加项目详情" @back="handlePageBack">
    <div class="template-wrapper">
      <el-form class="panel-form" inline label-width="90px">
        ...
        <el-form-item>
          <path-box-label slot="label" title="服务器地址" :memo="form.serverAddressMemo" />
          <path-box class="input-block" :url="form.serverAddress" :memo="form.serverAddressMemo" />
        </el-form-item>
        <el-form-item>
          <path-box-label slot="label" title="本地地址" :memo="form.localAddressMemo" />
          <path-box class="input-block" :url="form.localAddress" :memo="form.localAddressMemo" />
        </el-form-item>
        <el-form-item>
          <path-box-label slot="label" title="SVN地址" :memo="form.svnAddressMemo" />
          <path-box class="input-block" :url="form.svnAddress" :memo="form.svnAddressMemo" />
        </el-form-item>
        <el-form-item label="API地址">
          <path-box-label slot="label" title="API地址" :memo="form.apiAddressMemo" />
          <path-box class="input-block" :url="form.apiAddress" :memo="form.apiAddressMemo" />
        </el-form-item>
...
import PathBoxLabel from 'components/basic/PathBoxLabel'
import PathBoxContent from 'components/basic/PathBoxContent'
...
export default {
  name: 'ProjectEdit',
  components: { Page, PathBoxLabel, PathBoxContent }, // , Panel
  data() {
    return {
      update: false,
      type: '',
