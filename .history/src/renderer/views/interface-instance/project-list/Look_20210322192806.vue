    ...
    <div class="template-wrapper">
      <el-form class="panel-form" inline label-width="90px">
        <el-form-item label="项目名称"
          ><div class="input-inline">{{ form.title }}</div></el-form-item
        >
        <el-form-item label="项目简称"
          ><div class="input-inline">{{ form.abbreviation }}</div></el-form-item
        >
        <el-form-item label="文件名称"
          ><div class="input-inline">{{ form.fileName }}</div></el-form-item
        >
