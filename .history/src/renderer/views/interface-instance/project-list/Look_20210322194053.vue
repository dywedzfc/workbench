    ...
    <div class="template-wrapper">
      <el-form class="panel-form" inline label-width="90px">
        <el-form-item label="项目名称">
          <div class="input-block">{{ form.title }}</div>
        </el-form-item>
        <el-form-item label="项目简称">
          <div class="input-inline_mini">{{ form.abbreviation }}</div>
        </el-form-item>
        <el-form-item label="文件名称">
          <div class="input-inline_mini">{{ form.fileName }}</div>
        </el-form-item>
        <el-form-item label="项目类型">
          <div class="input-inline_mini">{{ form.type }}</div>
        </el-form-item>
        <el-form-item label="服务器地址">
          <div class="input-block">{{ form.remotelyAddress }}</div>
        </el-form-item>
        <el-form-item label="本地地址">
          <div class="input-block">{{ form.localAddress }}</div>
        </el-form-item>
        <el-form-item label="SVN地址">
          <div class="input-block">{{ form.svnAddress }}</div>
        </el-form-item>
        <el-form-item label="API地址">
          <div class="input-block">{{ form.apiAddress }}</div>
        </el-form-item>
        <el-form-item label="备注">
          <div class="input-block">{{ form.remark }}</div>
        </el-form-item>
      </el-form>
    </div>
  </page>
