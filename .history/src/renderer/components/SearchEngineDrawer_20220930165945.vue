          ...
          this.$nextTick(() => {
            ...
            twoIframe.addEventListener('did-stop-loading', () => {
              ...
              const styleList = [
                ...
                '.b_respl #b_results .b_rc_gb_template .b_widgetContainer { left: calc(100% + 127px); visibility: visible; padding-left: 0; padding-right: 8px; border-radius: 0 15px 15px 0; }',
