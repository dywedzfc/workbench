        ...
        if (value) {
          this.$nextTick(() => {
            ...
            oneIframe.addEventListener('did-stop-loading', () => {
              ...
              xhr.open('GET', '../assets/style/baidu-style.css', true)
              xhr.onload = function () {
                ...
                if (this.status === 200) {
                  ...
                  console.info('data-load:', name, this.status, filename)
              ...
              const baiduStyle = new FileReader()
              // baiduStyle.readAsDataURL(import('../assets/style/baidu-style.css'))
              // import('../assets/style/baidu-style.css').then((res) => {
              //   console.info('style-baidu:', res)
              // })
              console.info('style-baidu:', baiduStyle, __filename)
