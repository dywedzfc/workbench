            ...
            oneIframe.addEventListener('did-stop-loading', () => {
              ...
              oneIframe.executeJavaScript(
                [
                  ...
                  `const sponsored3 = document.querySelectorAll('[data-click="{" rsv_bdr":"0","p5":1}"]'); for(let i = 0; i < sponsored3.length; i++) { const item = sponsored3[i]; console.info('result-item:', item); }`,
                ].join(' ')
              )
