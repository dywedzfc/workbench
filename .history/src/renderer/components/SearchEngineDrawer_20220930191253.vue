          ...
          this.$nextTick(() => {
            ...
            theIframe.addEventListener('did-stop-loading', () => {
              ...
              const styleList = [
                ...
                '.b_respl #b_content { padding-left: 30px; }',
                '#sogou_wrap_id .header .logo, #sogou_wrap_id .header .top-bar, #sogou_wrap_id .header #searchForm, #sogou_wrap_id #right, #sogou_wrap_id #s_footer, #sogou_wrap_id #float_uphint { display: none; }',
