          ...
          this.$nextTick(() => {
            ...
            twoIframe.addEventListener('did-stop-loading', () => {
              ...
              const styleList = [
                ...
                '.b_respl #b_header #sb_form, #b_content .ev_talkbox_wrapper, #ev_talkbox_wrapper, aside[aria-label="更多结果"], aside[aria-label="Additional Results"], #b_footer { display: none; }',
