        ...
        if (value) {
          this.$nextTick(() => {
            ...
            oneIframe.addEventListener('did-stop-loading', () => {
              ...
              const styleList = [
                '#head { display: none; }',
                '.wrapper_new #s_tab {     width: auto; padding-top: 15px; padding-left: 30px; }',
                '#container.sam_newgrid { margin: 0; padding-left: 30px; }',
                '#container.sam_newgrid #content_right { display: none; }',
              ]
