        ...
        if (value) {
          this.$nextTick(() => {
            ...
            oneIframe.addEventListener('did-stop-loading', () => {
              ...
              oneIframe.insertCSS(
                '#head { display: none; } .wrapper_new #s_tab { padding-top: 15px; } #container.sam_newgrid { margin: 0; padding-left: 30px; } #container.sam_newgrid #content_right { display: none; }'
              )
