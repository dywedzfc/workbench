          ...
          this.$nextTick(() => {
            ...
            oneIframe.addEventListener('did-stop-loading', () => {
              ...
              oneIframe.executeJavaScript(
                `const sponsored = document.querySelectorAll('._2z1q32z'); for(let i = 0; i < sponsored.length; i++) { const item = sponsored[i]; console.info('item:', item); item.style.display = 'none'; }`,
                `const sponsored2 = document.querySelectorAll('._8pnr6st'); for(let i = 0; i < sponsored2.length; i++) { const item = sponsored2[i]; console.info('item:', item); item.style.display = 'none'; }`,
                `const sponsored3 = document.querySelectorAll('.result'); console.info('data-ss3:', sponsored3);`
              )
