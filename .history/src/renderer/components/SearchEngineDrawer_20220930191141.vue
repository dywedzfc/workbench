        ...
        if (value) {
          this.$nextTick(() => {
            ...
            oneIframe.addEventListener('did-stop-loading', () => {
              ...
              oneIframe.insertCSS(styleList.join(' ')) // oneIframe.executeJavaScript('console.info("ceshi")')
            ...
            theIframe.addEventListener('did-stop-loading', () => {
              console.log('did-stop-loading...')
              const styleList = [
                'html, body, #sogou_wrap_id, #sogou_wrap_id .header, #sogou_wrap_id .float_uphint { min-width: 680px !important; }',
                '.b_respl #b_content { padding-left: 30px; }',
                '#sogou_wrap_id .header .logo, #sogou_wrap_id .header .top-bar, #sogou_wrap_id .header #searchForm, #sogou_wrap_id #right, #sogou_wrap_id #s_footer { display: none; }',
                '#sogou_wrap_id .header .searchnav { display: block; padding-left: 15px; }',
                '#sogou_wrap_id .header.headsearch { min-width: 680px; }',
