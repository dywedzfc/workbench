            ...
            oneIframe.addEventListener('did-stop-loading', () => {
              ...
              oneIframe.executeJavaScript(
                [
                  ...
                  `const sponsored3 = document.querySelectorAll('.c-gap-left'); for(let i = 0; i < sponsored3.length; i++) { const item = sponsored3[i]; if (item.innerText == '广告') console.info('result-item:', item.parentElement.parentElement.parentElement); }`,
                ].join(' ')
              )
