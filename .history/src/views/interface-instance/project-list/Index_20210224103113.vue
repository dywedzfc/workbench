...
export default {
  ...
  data() {
    return { query: '', projectList: { data: [], count: '' } }
  },
  computed: {
    filterProjectList() {
  ...
  methods: {
    ...
    handleProjectClick() {
      ...
      let { count } = this.projectList
      console.info('count:', ++count)
      this.addProjectInfo({ id: ++this.projectList.count, title: this.query })
      console.info('count-2:', count, this.projectList.count)
      // setProjectFolder(this.projectList.data, this.projectList.countcount)
    },
