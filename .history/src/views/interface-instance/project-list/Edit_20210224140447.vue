    ...
    <div class="template-wrapper">
      <el-form class="panel-form" inline label-width="80px">
        <el-form-item label="项目名称">
          <el-input class="input-block" v-model="projectItem.projectName"></el-input>
        </el-form-item>
        <el-form-item label="文件名称">
          <el-input class="input-inline" v-model="projectItem.fileName"></el-input>
        </el-form-item>
        <el-form-item label="项目类型">
          <el-input class="input-inline" v-model="projectItem.type"></el-input>
          <!-- <el-select class="input-inline" v-model="projectItem.type"></el-select> -->
        </el-form-item>
        <el-form-item label="远程地址">
          <el-input
            class="input-block input-textarea"
            v-model="projectItem.remotelyAddress"
            type="textarea"
            rows="3"
          ></el-input>
        </el-form-item>
        <el-form-item label="本地地址">
          <el-input
            class="input-block input-textarea"
            v-model="projectItem.localAddress"
            type="textarea"
            rows="2"
          ></el-input>
        </el-form-item>
        <el-form-item label="API地址">
          <el-input
            class="input-block input-textarea"
            v-model="projectItem.apiAddress"
            type="textarea"
            rows="2"
          ></el-input>
        </el-form-item>
