    ...
    <div class="template-wrapper">
      <el-form class="panel-form" inline label-width="80px">
        ...
        <el-form-item label="项目简称">
          <el-input class="input-inline" v-model="form.abbreviation"></el-input>
        </el-form-item>
        <el-form-item label="文件名称">
          <el-input class="input-inline" v-model="form.fileName"></el-input>
        </el-form-item>
        <el-form-item label="json名称">
          <el-input class="input-inline" v-model="form.jsonFileName"></el-input>
        </el-form-item>
...
import { PROJECT_SELECT, requestUpdProject } from 'assets/script/request',// , requestSetProjectSelect
...
export default {
  ...
  watch: {
    projectItem: {
      handler(item) {
        console.info('project:', 'id' in item)
