    ...
    <div class="template-wrapper">
      <el-form class="panel-form" inline label-width="80px">
        <el-form-item label="项目名称">
          <el-input class="input-block" v-model="form.projectName"></el-input>
        </el-form-item>
        ...
        <el-form-item label="账号">
          <el-input class="input-inline" v-model="form.username"></el-input>
        </el-form-item>
        <el-form-item label="密码">
          <el-input class="input-inline" v-model="form.password"></el-input>
          <!-- <el-select class="input-inline" v-model="form.type"></el-select> -->
        </el-form-item>
