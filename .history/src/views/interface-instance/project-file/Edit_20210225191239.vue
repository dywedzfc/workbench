...
import { TABLE_FILE_SELECT, requestUpdTableFile } from 'assets/script/request' // , requestSetProjectSelect
...
export default {
  ...
  computed: {
    ...mapGetters({ projectItem: PROJECT_SELECT, tableFileItem: TABLE_FILE_SELECT })
  },
  watch: {
    tableFileItem: {
      handler(item) {
