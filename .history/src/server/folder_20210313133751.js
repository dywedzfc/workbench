...
// import { CONFIG_PATH, PROJECT_FILE_NAME, TABLE_FILE_NAME } from 'util'
const { CONFIG_PATH, PROJECT_FILE_NAME, TABLE_FILE_NAME } = require('util')
// const fs = require('fs')
