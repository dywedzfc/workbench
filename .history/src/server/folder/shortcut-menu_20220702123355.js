...
export function getProjectFolder() {
  ...
  const { path } = createFile(SHORTCUT_MENU_FILE_NAME, null, {
    data: [
      { id: 1, title: '日报', icon: 'el-icon-tickets', operate: 0, href: '/daily' },
      { id: 2, title: '月报', icon: 'el-icon-date', operate: 0, href: '/monthly' },
      { id: 3, title: '项目', icon: 'el-icon-folder', operate: 0, href: '/jkzsl/list' },
    ],
    count: 0,
  })
  try {
