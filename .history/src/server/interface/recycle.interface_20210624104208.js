...
import { hasProjectNameFolder, delProjectFolder, realDelProjectFolder } from '../folder/project'
...
function removeProjectItem(data) {
  ...
  if (hasFolder.code == 301) {
    ...
    else return { code: 400, msg: '文件删除失败。可能是内部文件删除堵塞导致，可以再次尝试删除。' }
