...
app.on('ready', async () => {
  ...
  globalShortcut.register('CommandOrControl+1', () => {
    // course.mainWindow.webContents.openDevTools()
    course.mainWindow.webContents.send('href', '/')
    console.info('CommandOrControl+1:')
  })
  globalShortcut.register('CommandOrControl+2', () => {
    // course.mainWindow.webContents.openDevTools()
    course.mainWindow.webContents.send('href', '/daily')
    console.info('CommandOrControl+2:')
  })
