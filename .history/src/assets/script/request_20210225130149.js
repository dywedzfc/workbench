...
// 项目表文件
export const TABLE_FILE_LIST = 'project/list'
export const TABLE_FILE_COUNT = 'project/count'
export const TABLE_FILE_SELECT = 'project/select'
export function requestTableFileList() {
  store.dispatch('project/FIND_TABLE_FILE_LIST')
}
