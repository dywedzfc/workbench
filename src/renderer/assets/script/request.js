...
// 初始化文件夹
export const MENU = 'init/menu'
export const MENU_SHOW = 'init/menuShow'
export const INIT_GENERAL = 'init/general'
export const THEME_COLOR = 'init/themeColor'
export const GENERAL_THEME = 'init/generalTheme'
export const GENERAL_ACCENT_COLOR = 'init/generalAccentColor'
...
export function requestSetMenuShow(value) {
  store.commit('init/SET_MENU_SHOW', value)
}
export function requestSetGeneralTheme(value) {
  store.commit('init/SET_GENERAL_THEME', value)
}
export function requestSetGeneralAccentColor(value) {
  store.commit('init/SET_GENERAL_ACCENT_COLOR', value)
}
